...
//
//	private MoonAndSunCtrl sunMoonBtnCtrl;
//	private MicroPhoneBtnCtrl microphoneBtnCtrl;
//
...
//		sunMoonBtnCtrl=sunMoonBtn.GetComponent<MoonAndSunCtrl> ();
//		microphoneBtnCtrl=micphoneBtn.GetComponent<MicroPhoneBtnCtrl> ();
//
//	}
//
//	//声控+光敏    （只有晚上有声音的时候灯才亮）
...
//				isFingerShow=true;
//			}
//			if (sunMoonBtnCtrl.isDaytime && !preSunSwitchStatues)//如果是白天，之前的按钮是月亮，说明是从晚上切换到白天
//			{
//				microphoneBtnCtrl.isCollectVoice=false;
//				isStartRecord = false;
//				VOTime = 5f;
//			}
//			#region 如果是晚上（点击了太阳按钮）
//			if (!sunMoonBtnCtrl.isDaytime) 
//			{ 
...
//					}
//				}
//				if (isLAswitchOn)//如果光敏开光闭合了，小话筒按钮可以点击
//				{	
//					
...
//				}
//				if (microphoneBtnCtrl.isCollectVoice)//点击了话筒按钮
//				{ 
...
//					}
//					if (isVOswitchOn) //如果声控闭合了，5秒后要弹开
//					{
////						CurrVOSwitchStatus=true;
//
...
//							VOTimer = 0;
//
////							if (PreVOSwitchStatus!=CurrVOSwitchStatus)
////							{
...
//////								isStartRecord = false;
//////								isCountDownShow=false;
////								PreVOSwitchStatus=CurrVOSwitchStatus;
////								CurrVOSwitchStatus=PreVOSwitchStatus;
////
////							}
//
//							GetImage._instance.cf.switchOnOff (int.Parse (VoiceDelaySwitch.gameObject.tag), false);
...
//			}
//			#endregion
//			preSunSwitchStatues = sunMoonBtnCtrl.isDaytime;
